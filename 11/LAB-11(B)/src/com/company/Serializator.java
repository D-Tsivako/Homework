...
public class Serializator {
    public boolean serialization(Bouquet bouquet, String fileName) {
        boolean flag = false;
        ...
        try {
            ...
            if (fos != null) {
                ...
                ostream.writeObject(bouquet); // сериализация
                ostream.writeBoolean(bouquet.tape);
                flag = true;
            }
